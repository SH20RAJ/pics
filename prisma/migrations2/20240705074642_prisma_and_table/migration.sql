...
CREATE TABLE "UserImageQuota" (
    ...
    CONSTRAINT "UserImageQuota_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UserImageQuota" ADD CONSTRAINT "UserImageQuota_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
